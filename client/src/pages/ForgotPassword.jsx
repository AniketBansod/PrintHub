  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 p-4 relative">
        <div className="absolute top-4 left-4 sm:top-8 sm:left-8">
            <button onClick={() => navigate(-1)} className="flex items-center text-gray-300 hover:text-white transition-colors duration-200">
      ...
      <motion.div
        ...
        className="bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-8 w-full max-w-md border border-gray-700"
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300">Reset your password in three easy steps.</p>
        </div>
          ...
          <form onSubmit={handleSendOtp} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  className="w-full pl-10 pr-4 py-3 rounded-lg bg-gray-700 border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200"
            ...
            <button type="submit" disabled={loading} className="w-full py-3 rounded-lg font-semibold transition-all duration-300 bg-amber-500 hover:bg-amber-600 text-gray-900 shadow-lg disabled:bg-gray-600">
