      ...
      >
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            ...
            />
            <h1 className="text-2xl font-bold text-amber-400">PrintEase</h1>
          </div>
        ...
        <div className="flex items-center justify-center mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div className={`w-16 h-1 ${step >= 3 ? 'bg-amber-500' : 'bg-gray-600'}`}></div>
            <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
              step >= 3 ? 'bg-amber-500 text-gray-900' : 'bg-gray-600 text-gray-300'
            }`}>
              3
            </div>
          </div>
          ...
          <form onSubmit={handleVerifyOTP} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-colors duration-200 text-center text-2xl tracking-widest"
                placeholder="000000"
                maxLength="6"
              />
            </div>
