...
const StudentDashboard = () => {
  ...
  return (
    <div className="h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 flex transition-colors duration-200 overflow-hidden">
      {/* --- Responsive Sidebar --- */}
      <aside
        className={`absolute md:relative z-20 h-full w-64 bg-white dark:bg-gray-800 p-4 flex flex-col border-r border-gray-200 dark:border-gray-700 transition-transform duration-300 ease-in-out ${
      ...
      <main className="flex-1 p-4 md:p-8 overflow-y-auto">
        <button
          ...
          className="md:hidden p-2 text-gray-500 dark:text-gray-300 mb-4"
        >
          <Menu size={28} />
        </button>
